...
import { socketService, SOCKET_EMIT_CONNECTED, SOCKET_ON_ADDCHAT, SOCKET_ON_ADDMSG, SOCKET_ON_UPDATE_CHAT } from '../../services/socket.service'
...
export default function ChatContent({ openUserDetails, onReceivedMsg, onChatUpdated, onAddChat }) {
    ...
    return (
        <section className="chat flex column">
            {(!currChat || !currChat.msgs) ? <NoMsg /> :
                <>
                    <ChatHeader receiver={getReceiver(currChat.users, user)} openUserDetails={openUserDetails} />
