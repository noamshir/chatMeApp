  ...
  return (
    <div className='chat-send-container flex'>
      ...
      <div className='chat-msg-btns flex'>
        <div onClick={() => setIsEmojiOpen(!isEmojiOpen)} className='btn-1'>
        ...
        />
        <label htmlFor='file' className='img-pick-btn'>
          <ImageIcon />
        </label>
        <button className='btn-3' onClick={onSendMsg}>
          <SendOutlinedIcon className='send-icon' />
        </button>
      </div>
      {isSending && (
        <div className='sending-msg-container'>
          <Loader />
        </div>
      )}
    </div>
